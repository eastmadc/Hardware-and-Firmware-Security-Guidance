...
## <a name="about">1. About this resource</a>
As of November, 2024, the guidance contained within this document is considered obsolete and no longer applicable to fully patched systems or hardware released in 2021 or newer. The following content is considered historical.

This document provides content for aiding DoD administrators in verifying systems have applied and enabled mitigations for hardware and firmware vulnerabilities such as side-channel and UEFI vulnerabilities. The guidance below is a companion to NSA Cybersecurity Advisories such as [Vulnerabilities Affecting Modern Processors](https://www.nsa.gov/Portals/70/documents/what-we-do/cybersecurity/professional-resources/csa-vulnerabilities-affecting-modern-processors.pdf).

## <a name="scvuln">2. Side-channel vulnerabilities</a>
### <a name="mitigations">2.1 Mitigations</a>
...
#### <a name="firmpatch">2.1.1 Firmware updates</a>
...
#### <a name="softpatch">2.1.2 Software patches</a>
...
#### <a name="config">2.1.3 Configuration changes</a>
...
#### <a name="hyper">2.1.4 Disable Intel Hyper-Threading on Sensitive Systems</a>
...
#### <a name="verify">2.1.5 Verification</a>
To test that patches are successful see the section named [Verification](./verification).

### <a name="products">2.2 Resources and Affected products</a>
...
#### <a name="hardresources">2.2.1 Hardware resources</a>
...
#### <a name="softresources">2.2.2 Software Resources</a>
...
#### <a name="advisories">2.2.3 Advisory resources</a>
...
### <a name="attacks">2.3 Publicized attacks</a>
#### <a name="spectre">2.3.1 Spectre | CVE-2017-5715, CVE-2017-5753, CVE-2018-3639, and CVE-2018-3665</a>
...
#### <a name="meltdown">2.3.2 Meltdown | CVE-2017-5754 and CVE-2018-3640</a>
...
#### <a name="foreshadow">2.3.3 Foreshadow | CVE-2018-3615, CVE-2018-3620, and CVE-2018-3646</a>
...
#### <a name="branchscope">2.3.4 BranchScope | CVE-2018-9056</a>
...
#### <a name="tlbleed">2.3.5 TLBleed | No CVE issued</a>
...
#### <a name="portsmash">2.3.6 PortSmash | CVE-2018-5407</a>
...
#### <a name="netspectre">2.3.7 NetSpectre | No CVE issued</a>
NetSpectre is the only side-channel vulnerability listed on this page that does not require local code execution on a target system. Attackers can target systems connected to a network and flood them with data -- particularly data that takes advantage of AVX instruction sets. Processing of that data can reveal electronic indicators that allow the leaking or duplication of system secrets. NetSpectre is a noisy and slow attack method due to the large amount of data that must be sent to the target machine. An exploitable network driver, network service, or network application, such as a web browser, is>2.3.8 Microarchitectural Data Sampling (MDS) | CVE-2018-12130, CVE-2018-12127, CVE-2018-12126, and CVE-2019-11091</a>
...
#### 2.3.9 <a name="CacheOut">CacheOut | _CVE_-2020-0548 | _CVE_-2020-0549</a>
...
#### 2.3.10 <a name="TAW">Take A Way (TAW)</a>
...
#### 2.3.11 <a name="LVI">Load Value Injection (LVI) | CVE-2020-0551</a>
...
## <a name="firmandmicro">3. Firmware and microcode vulnerabilities</a>
### <a name="lojax">3.1 LoJax</a>
...
### <a name="amdflaws">3.2 Ryzenfall, Chimera, Fallout, and Masterkey</a>
...
### <a name="MSFTSBB">Microsoft Secure Boot Bypass | CVE-2020-0689</a>
...
## <a name="bootconfig">4. Boot configuration</a>

### <a name="uefihard">4.1 UEFI Hardening</a>
...
### <a name="sbcustom">4.2 UEFI Secure Boot Customization</a>
...
## <a name="upgrade">5. Hardware Upgrade Guidance</a>
